...
const ProductCard= ({title,price,offer}) => {
    //console.log(`dot notation ${(props.offer)}`);
    ...
    <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      {
        CardData.map((item,index) => {
          return(
             ...
             // {/*<ProductCard tittle = {"hello"} price={3000} offer={20}/>*/}
          )
        })
      }
...
//What is props?
    //const ProductCard= (props) => {
        //have given props as a object.can give any name this is called props
        //<ProductCard tittle = {"hello"} price={3000} offer={20}/>(to acces this line we are using props)
...
//how to receive props
        ////if u inspect you can see it's recieved as a object offer:20 //to acess this below 2 steps
        //console.log(`dot notation ${(props.offer)}`);  
    //console.log(`Bracket notation ${props["title"]}`);


//how to render props
        //can customize using dot notatation and bracket notation (ex->see code no 400)
        //can also render using destructuring instead of these 2 methods


//list = > [{ },{}] array of object why? when it was hard to copy paste &change the data in component.
    // ex -> see code no 538 to 544


//key = {index} -> if u use this and inspect this if need diff key 
// to solve this error use this -> key = {item.id} ,
//if is not there or from backend using uuid ->installtion cmd npm i uuid(uuid npm web)
//and import { v4 as uuidv4 },uuidv4()from 'uuid'; and key = {uuidv4()} 
